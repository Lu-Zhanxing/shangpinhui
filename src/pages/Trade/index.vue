<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(good,index) in tradeGoodList.detailArrayList" :key="good.skuId">
          <li>
    ...
    <div class="money clearFix">
      <ul>
        <li>
          <b><i>{{tradeGoodList.totalNum}}</i>件商品，总商品金额</b>
    ...
    <div class="trade">
      <div class="price">应付金额:　<span>¥{{tradeGoodList.totalAmount}}</span></div>
